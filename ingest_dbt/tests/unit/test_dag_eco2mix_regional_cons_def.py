...
def test_dag_eco2mix_regional_cons_def_structure(monkeypatch):
    ...
    spec = importlib.util.spec_from_file_location("dag_eco2mix_regional_cons_def", path)
    ...
    assert dag.dag_id == "dag_eco2mix_regional_cons_def"
