...
def test_dag_eco2mix_national_tr_structure(monkeypatch):
    ...
    spec = importlib.util.spec_from_file_location("dag_eco2mix_national_tr", path)
    ...
    assert dag.dag_id == "dag_eco2mix_national_tr"
