...
def dag_eco2mix_national_cons_def():
    ...
    @task.bash(task_id="dbt_eco2mix_national_cons_def")
    def dbt_reg_cons_def():
        return f"""
        cd {DBT_DIR} &&
        dbt run --select eco2mix_national_cons_def_histo+ --target prod
        """
