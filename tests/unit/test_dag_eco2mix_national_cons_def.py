...
def test_dag_eco2mix_national_cons_def_structure(monkeypatch):
    ...
    spec = importlib.util.spec_from_file_location("dag_eco2mix_national_cons_def", path)
    ...
    assert dag.dag_id == "dag_eco2mix_national_cons_def"
    assert dag.schedule.crons == (
        "30 9 20 * 1-5",
        "30 9 21 * 1",
        "30 9 22 * 1",
    )
